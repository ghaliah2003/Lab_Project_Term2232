...
**Student Name:\< ghaliah \>**

**Student ID:\< 2221006745 \>**
...
represents one pet int he dataset.
...
among registered pets. Filtering Records for Species Pig: pig_records
...
Brief Summary: This code filters the records in the seattlepets dataset
to include only those for the species “Pig”, arranges these filtered
records alphabetically by pet names, and then displays the sorted pig
records. It provides a sorted list of pig records, making it easier to
analyze and interpret the data related to pigs.
...
![](Lab_project_files/figure-gfm/unnamed-chunk-7-1.png)<!-- --> Write
